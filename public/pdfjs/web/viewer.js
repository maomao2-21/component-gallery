...
var PDFViewerApplication = {
  ...
  download: function download() {
    ...
    var filename = localStorage.getItem('downLoadDh') || this.contentDispositionFilename || (0, _ui_utils.getPDFFileNameFromURL)(this.url);
    // var filename = '666';
  ...
  _createClass(PDFPageView, [{
    ...
    value: function draw() {
      ...
      if (this.textLayerMode !== _ui_utils.TextLayerMode.DISABLE && this.textLayerFactory) {
        ...
        var drag =false
        textLayerDiv.id = 'textLayer' + this.id;
        textLayerDiv.onmousedown  = function(e){
          drag=true
          onmousedown(e,this.id);
          textLayerDiv.onmousemove  = function(e){
            if(drag){

              onmousemove(e,this.id);
            }
          };
        };
        
        textLayerDiv.onmouseup = function(e){
          drag =false
          onmouseup(e,this.id);
        };
        textLayerDiv.name = 'textLayerName';
...
PDFPrintService.prototype = {
  layout: function layout() {
    ...
    this.pageStyleSheet.textContent = '@supports ((size:A4) and (size:1px 1px)) {' + '@page { size: ' + pageSize.width + 'px ' + pageSize.height*1.1  + 'px;}' + '}';
